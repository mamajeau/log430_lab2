/* ATM Example system - file Status.java copyright (c) 2001 - Russell C. Bjork */

package edu.gordon.atm.ui.interfaces;

/**
 * Abstract base class for representation of various status codes returned by
 * bank for a transaction. The bank will create appropriate subclasses.
 */
