/* ATM Example system - file Transfer.java copyright (c) 2001 - Russell C. Bjork */
...
public class Transfer extends Transaction {
   ...
   */
  public Transfer(Card card, int pin) {
    super(card, pin);
  }
    ...
    return new Receipt(bankName, atmID, atmPlace, card, serialNumber, total,
        available) {
      {
        ...
        detailsPortion[0] = "TRANSFER FROM: "
            + AccountInformation.ACCOUNT_ABBREVIATIONS[from] + " TO: "
