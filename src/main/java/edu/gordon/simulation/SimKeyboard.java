/* ATM Example system - file SimKeyboard.java copyright (c) 2001 - Russell C.
 * Bjork */
...
class SimKeyboard extends Panel {
   ...
   *
   */
  private static final long serialVersionUID = -487740071394714710L;
  /**
   ...
   */
  private SimCustomerConsole display;
  /**
   ...
   */
  SimKeyboard(SimCustomerConsole display,
