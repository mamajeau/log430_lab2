/* ATM Example system - file GUI.java copyright (c) 2001 - Russell C. Bjork */
...
class GUI extends Panel {
   ...
   *
   */
  private static final long serialVersionUID = 2075845995132243052L;
   ...
   */
  static GridBagConstraints makeConstraints(int row, int col, int width,
      int height, int fill) {
   ...
   */
  GUI(SimOperatorPanel operatorPanel, SimCardReader cardReader,
      SimCustomerConsole display, SimKeyboard keyboard,
      SimCashDispenser cashDispenser, SimEnvelopeAcceptor envelopeAcceptor,
    ...
    atmPanel = new ATMPanel(this, operatorPanel, cardReader, display, keyboard,
