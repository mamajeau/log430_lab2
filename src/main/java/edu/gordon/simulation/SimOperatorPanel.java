/* ATM Example system - file SimOperatorPanel.java copyright (c) 2001 - Russell
 * C. Bjork */
...
class SimOperatorPanel extends Panel implements IOperatorPanel {
   ...
   *
   */
  private static final long serialVersionUID = -352006708268455687L;
   ...
   *          the overall edu.gordon.simulation object
   */
  SimOperatorPanel(final Simulation simulation) {
    ...
    final Label message = new Label("Click button to turn ATM on",
        Label.CENTER);
