...
public class Simulation extends ATM {
	...
	public Simulation(int id, String place, String bankName,
		...
		EventsManager.register(simulatedBank);
		EventsManager.register(new StatusComponent());
		EventsManager.register(new BalancesComponent());
	}
	...
	public void sendMessage(Message message, Transaction currTransact) {
		...
		EventsManager.post(new TransactionEvent(this, message, currTransact));
	}
